...
jQuery(document).ready(function ($) {
    ...
    $(document).on('found_variation', 'form.variations_form', function (event, variation) {
        var image_magnifier = yith_wcmg_default_zoom;
        if (variation.image_magnifier) {
            image_magnifier = variation.image_magnifier;
        }
        else if (variation.image) {
            image_magnifier = variation.image.full_src;
        }
