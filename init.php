 ...
 * Description: YITH WooCommerce Zoom Magnifier enables you to add a zoom effect to product images and a thumbnail
 * slider for the product image gallery.
 * Version: 1.2.24
 * Author: YITHEMES
...
if ( ! defined( 'YITH_YWZM_VERSION' ) ) {
	define( 'YITH_YWZM_VERSION', '1.2.24' );
}
